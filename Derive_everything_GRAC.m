...
syms t y dy ddy thh0 thh thk  tha dthk dtha ddthk ddtha tauk taua Fy m1 I1 m2 I2 m3 I3 m4 I4 l1 l2 l3 l4 lc2 lc3 lc4 lh0 g thm real
...
rcm4=ra+lc4*erahat;
rm=ra+.2*ermhat;
keypoints = [rcm1 rh0 rk ra re];% rm];  %rm for motor angle
